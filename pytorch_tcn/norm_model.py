...
class ResBlock(nn.Module):
    def __init__(self, dilation_rate, n_filters, kernel_size, padding, dropout_rate):
        ...
        self.res = og.OpNormConv1d(
            in_channels=in_channels,
            out_channels=n_filters,
            kernel_size=1,
            padding=padding,
        )
        self.conv_1 = og.OpNormConv1d(
            in_channels=in_channels,
            out_channels=n_filters,
